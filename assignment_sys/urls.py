...
urlpatterns = [
    ...
    path('give_materials', views.give_materials, name='give_materials'),
    path('lec_view_assignments', views.lec_view_assignments, name='lec_view_assignments'),
    path('lec_view_materials', views.lec_view_materials, name='lec_view_materials'),
    path('student_view_assignments', views.student_view_assignments, name='student_view_assignments'),
    path('student_view_materials', views.student_view_materials, name='student_view_materials'),
    ...
    path('find_lecturer', views.find_lecturer, name='find_lecturer'),
